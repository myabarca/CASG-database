...
if (isset($_POST['saveLoanButton'])) {
	...
	if(empty($_POST['dateClosed_loan'])) {   
 
    	
       		// insert query for entries without dateClosed
        	$query = "INSERT INTO loan (personID, dateRequested, dateSent, dateDue, authorizedBy, sentBy, processedBy, purpose, loanNotes) VALUES (:personID, :dateRequested, :dateSent, :dateDue, :authorizedBy, :sentBy, :processedBy, :purpose, :loanNotes)";
